...
parser.add_argument('-i', '--img', default='2.jpg', type=str,
    help='path for the image to test on')
args = vars(parser.parse_args())

# load label binarizer
lb = joblib.load('/Users/macbook/Downloads/gestures to speech/Train/lb.pkl')
...
model.load_state_dict(torch.load('/Users/macbook/Downloads/gestures to speech/Train/model.pth'))
print(model)
print('Model loaded')

image = cv2.imread(f"/Users/macbook/Downloads/gestures to speech/Train/Images/G/{args['img']}")
